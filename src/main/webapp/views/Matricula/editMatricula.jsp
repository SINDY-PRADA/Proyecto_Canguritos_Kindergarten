									...
									<div class="formulario__grupo-input">
									    <form action="matricula" method="POST" class="formulario" id="formulario">
											...
											<div class="formulario__grupo" id="grupo__nombreEstudiante">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="nombreEstu" id="nombreEstu"  value="${matriculaLists.getNombreEstu()}" readonly>
											...
											<div class="formulario__grupo" id="grupo__apellidoEstudiante">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="apellidoEstu" id="apellidoEstu" value="${matriculaLists.getApellidoEstu()}" readonly>
													<i class="formulario__validacion-estado fas fa-times-circle"></i>
												</div>
												<p class="formulario__input-error">Debe ser de 4 a 16 dígitos y solo puede contener letras</p>
											</div>
											...
											<div class="formulario__grupo">
											  ...
											  <div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input"  name="observacionEstudiante" id="observacionEstudiante" value="${matriculaLists.getObservacionEstu()}" readonly>
												</div>
											</div>
											  ...
											  <div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="observacionRectora" id="observacionRectora" value="${matriculaLists.getObservacionRectora()}">
												</div>
											</div>
											...
											<div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="number" class="formulario__input" name="anolectivo" id="anolectivo" value="${matriculaLists.getIdAnolectivo()}">
												</div>
											</div>
											...
											<div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="number" class="formulario__input" name="estu" id="estu"  value="${matriculaLists.getIdEstudiante()}">
												</div>
											</div>
											...
											<div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
												<select class="formulario__input" name="estadoMatricula" id="estadoMatricula" value="${matriculaLists.getEstadoMatricula()}">
													<option class="formulario__input">EN REVISION</option>
													<option class="formulario__input">RECHAZADO</option>
													<option class="formulario__input">ACEPTADO</option>
												  </select>
											</div>
										</div>
											<br>
