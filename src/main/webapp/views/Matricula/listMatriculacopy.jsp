...
<body>
  ...
  if (OK) {
	$.ajax({
	  url:"matricula?accion=editarMatriculaEts&idMatricula="+id,
	...
	icon: "success",
			...
			if(OK){
				location.href="matricula?accion=editarMatriculaEts&idMatricula="+id
			}
		  });
  } else {
	...
	<section class="full-box dashboard-contentPage">
		...
		<!-- Content page -->
		<h4>   Debes adjuntar un solo archivo PDF con los siguientes documentos para formalizar la matrícula:</h4>
		<h4> ✔ Copia del registro civil de nacimiento del estudiante.</h4>
		<h4> ✔ Copia del documento de identidad del acudiente.</h4>
		<h4> ✔ Copia del carnet de vacunas al día y/o reporte del PAI.</h4>
		<h4> ✔ Copia del certificado de afiliación a una EPS con fecha reciente.</h4>
		<br>
	</div>
				...
				<li><a href="matricula?accion=añadirMatricula" style="text-decoration:none">Agregar</a></li>
              	...
              	<li><a href="matricula?accion=consultarMatriculaEst" style="text-decoration:none">Consultar</a></li>
					...
					<div id="myTabContent" class="tab-content">
					  	<div class="tab-pane fade active in" id="matricula?accion=consultarMatriculaEst">
								...
								<table class="table table-hover text-center">
									...
									<tbody>
										...
										<tr>
											...
											<td>${matriculaLists.getArchivo()}</td>
