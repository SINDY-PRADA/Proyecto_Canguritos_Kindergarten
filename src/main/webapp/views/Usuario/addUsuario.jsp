									...
									<div class="formulario__grupo-input">
									    <form action="usuario" method="POST" class="formulario" id="formulario">
											...
											<div class="formulario__grupo" id="grupo__username">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="nombreUsuario" id="nombreUsuario" placeholder="Mariana">
											...
											<div class="formulario__grupo" id="grupo__pass">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="contrasenaUsuario" id="contrasenaUsuario" placeholder="********">
													<i class="formulario__validacion-estado fas fa-times-circle"></i>
												</div>
											...
											<div class="formulario__grupo formulario__grupo-btn-enviar">
												<button type="submit" class="btn btn-info btn-raised btn-sm" name="accion" value="add" style="height: 40px;"><i class="zmdi zmdi-floppy"></i> AGREGAR</button>
											</div> 
									    </form>
									</div>
								</div>
