		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					...
					<figcaption class="text-center text-titles">Milena Lopez</figcaption>
				</figure>
									...
									<div class="formulario__grupo-input">
									    <form action="estudiante" method="POST" class="formulario" id="formulario">
										    ...
										    <div class="formulario__grupo formulario__grupo-btn-enviar">
										    	<button class="btn btn-info btn-raised btn-sm" name="accion" value="actualizarEst" style="height: 40px;" onclick="return ConfirmEdicion()" onclick="return valtel()"><i class="zmdi zmdi-floppy"></i> EDITAR</button>
										    </div> 
                                        </c:forEach>
									    </form>
									</div>
