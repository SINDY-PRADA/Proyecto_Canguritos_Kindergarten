								...
								<div class="row">
									<div class="formulario__grupo-input">
									    <form action="matricula" method="POST" class="formulario" id="formulario">
                                            <c:forEach var="matriculaLists" items="${matriculaLists}">
				
											<div class="formulario__grupo" id="grupo__nombreEstudiante">
												<label for="nombreEstudiante" class="formulario__label">Nombre Estudiante</label>
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="nombreEstu" id="nombreEstu"  value="${matriculaLists.getNombreEstu()}">
											...
											<div class="formulario__grupo" id="grupo__apellidoEstudiante">
												<label for="apellidoEstudiante" class="formulario__label">Apellido Estudiante</label>
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="apellidoEstu" id="apellidoEstu" value="${matriculaLists.getApellidoEstu()}">
													<i class="formulario__validacion-estado fas fa-times-circle"></i>
												</div>
												<p class="formulario__input-error">Debe ser de 4 a 16 dígitos y solo puede contener letras</p>
											</div>
											...
											<div class="formulario__grupo">
												...
												<input id="file-upload" onchange='cambiar()'accept="application/pdf" name="Archivo" id="Archivo" value="${matriculaLists.getArchivo()}" type="file" style='display: none;'/>
												<div id="info"></div> 
											</div>
											...
											<!-- <div class="formulario__grupo">
												<label class="formulario__label">Archivo PDF</label>
												<div class="formulario__grupo-input">
													<input type="file" class="formulario__input" name="Archivo" id="Archivo" value="${matriculaLists.getArchivo()}">
												</div>
											</div> -->
											  ...
											  <div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input"  name="observacionEstudiante" id="observacionEstudiante" value="${matriculaLists.getObservacionEstu()}">
												</div>
											</div>
											  ...
											  <div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="text" class="formulario__input" name="observacionRectora" id="observacionRectora" value="${matriculaLists.getObservacionRectora()}" readonly>
												</div>
											</div>
											...
											<div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="number" class="formulario__input" name="anolectivo" id="anolectivo" value="${matriculaLists.getIdAnolectivo()}" readonly>
												</div>
											</div>
											...
											<div class="formulario__grupo">
												...
												<div class="formulario__grupo-input">
													<input type="number" class="formulario__input" name="estu" id="estu"  value="${matriculaLists.getIdEstudiante()}"readonly>
												</div>
											</div>

											<br>
											<div class="formulario__grupo formulario__grupo-btn-enviar">
												<button class="btn btn-info btn-raised btn-sm" name="accion" value="actualizarMatriculaEst" style="height: 40px;"  onclick="return ConfirmEdicion()" onclick="return valtel()""><i class="zmdi zmdi-floppy"></i> EDITAR</button>
											</div> 
                                        </c:forEach>
									    </form>
									</div>
