			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="myTabContent" class="tab-content">
                      ...
                      <c:forEach var="acudiente" items="${acudienteLists}">
                          ...
                          <div class="formulario__grupo-input">
                          <input class="formulario__input" type="text" name="parentescoAcudiente" id="parentescoAcudiente" value="${acudiente.getParentescoAcudiente()}">
                        ...
                        <div class="formulario__grupo" id="grupo__nombreAcudiente">
                          ...
                          <div class="formulario__grupo-input">
                          <input class="formulario__input" type="text" name="nombreAcudiente" id="nombreAcudiente" value="${acudiente.getNombreAcudiente()}" >
                          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                          <p class="formulario__input-error">Debe ser de 4 a 16 dígitos y solo puede contener letras</p>
                        </div>
                        ...
                        <div class="formulario__grupo" id="grupo__apellidoAcudiente">
                          ...
                          <div class="formulario__grupo-input">
                          <input class="formulario__input" type="text" name="apellidoAcudiente" id="apellidoAcudiente" value="${acudiente.getApellidoAcudiente()}">
                          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                          <p class="formulario__input-error">Debe ser de 4 a 16 dígitos y solo puede contener letras</p>
                        </div>
                        ...
                        <div class="formulario__grupo">
                          ...
                          <div class="formulario__grupo-input">
                          <select class="formulario__input" name="tipoDocumento" id="tipoDocumento" value="${acudiente.getTipoDocumento()}">
                        ...
                        <div class="formulario__grupo" id="grupo__documentoAcudiente">
                          ...
                          <div class="formulario__grupo-input">
                          <input class="formulario__input" type="text" name="documentoAcudiente" id="documentoAcudiente" value="${acudiente.getDocumentoAcudiente()}">
                          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                        ...
                        <div class="formulario__grupo" id="grupo__profesionAcudiente">
                          ...
                          <div class="formulario__grupo-input">
                          <input class="formulario__input" type="text" name="profesionAcudiente" id="profesionAcudiente" value="${acudiente.getProfesionAcudiente()}">
                          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                            </div>
                          ...
                          <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="telefonoAcudiente" id="telefonoAcudiente" value="${acudiente.getTelefonoAcudiente()}">
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                            </div>
                          ...
                          <div class="formulario__grupo">
                            ...
                            <div class="formulario__grupo-input">
                              <input type="text" class="formulario__input" name="direccionAcudiente" id="direccionAcudiente" value="${acudiente.getDireccionAcudiente()}">
                              <i class="formulario__validacion-estado fas fa-times-circle"></i>
                            </div>
                          </div>
                          ...
                          <div class="formulario__grupo" id="grupo__correoAcudiente">
                            ...
                            <div class="formulario__grupo-input">
                              <input type="email" class="formulario__input" name="correoAcudiente" id="correoAcudiente" value="${acudiente.getCorreoAcudiente()}">
                              <i class="formulario__validacion-estado fas fa-times-circle"></i>
                              </div>
                        ...
                        <div class="formulario__grupo">
                            ...
                            <div class="formulario__grupo-input">
                              <select name="estadoAcudiente" id="estadoAcudiente" class="formulario__input"> 
                              <c:if test="${acudiente.getEstadoAcudiente() == false}">
                                <option value="${acudiente.getEstadoAcudiente()}">Inactivo</option>
                                <option value="true">Activo</option>
                              </c:if>
                              <c:if test="${acudiente.getEstadoAcudiente() == true}">
                                <option value="${acudiente.getEstadoAcudiente()}">Activo</option>
